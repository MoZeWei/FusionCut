...
class JCZCircuit:
    ...
    #QUES.: How to decompose CP gates in terms of gates above with arbitrary gates
    #We only valuate on the CP gate whose angle is pi, so that it equals to the CZ gate
    def add_CP(self, qubit1, qubit2, phase):
        self.add_CZ(qubit1, qubit2)

#TODO: Define add_CPhase (CNOT+Rz(y/2)+CNOT)
